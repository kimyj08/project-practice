...
//	}
	...
	public String insertAr(AskRvVO ar, AskVO ask) {
		...
		return "redirect:getAsk.zo?a_no="+ar.getAr_no() + "&um_no=" + ar.getUm_no() + "&bm_no=" + ar.getBm_no() + "&a_pmm=" + ask.getA_pmm();
	}
...
//	}
	...
	public String updateArProc(AskRvVO vo, AskVO ask) {
		...
		return "redirect:getAsk.zo?a_no="+vo.getAr_no() + "&um_no=" + vo.getUm_no() + "&bm_no=" + vo.getBm_no() + "&a_pmm=" + ask.getA_pmm();
	}
